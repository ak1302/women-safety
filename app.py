...
def sms_ahoy_reply():
    ...
    roads=[]
    # road_xpath = '//h1[@id="section-directions-trip-title-0" or @id="section-directions-trip-title-1" or@id="section-directions-trip-title-2"]/span'
    roads.append("Dr B R Ambedkar Marg/Gaondevi Marg")
    roads.append("Jagatguru Aadi Shankracharya Marg and Dr B R Ambedkar Marg/Gaondevi Marg")
    roads.append("Jagatguru Aadi Shankracharya Marg")
    print(roads)
    ...
    return jsonify({'safest route': final_result})
